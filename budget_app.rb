...
class Application
  ...
  def enter_debt
    ...
    # This stores the sum of all elements (amounts) in the input_arr (input array) in a variable called total_cc_debt (Total credit card debt).
    @total_cc_debt = input_arr.sum
  ...
  def enter_income
    # Displays the the text below where a user can enter in income amounts if multiple amounts.
