...
class Application
  ...
  def enter_debt
    ...
    # This displays the user's credit card debt amount.
  ...
  def enter_income
    ...
    # The total_monthly_income instance variable stores the user monthly income amount the adds chomp to remove the carriage return.
    @total_monthly_income = gets.chomp
  ...
  def debt_calculation
    # How many months does it take to pay off the credit card debt? Truncate 2 limits the float value to 2 digits.
    puts "The total time it will take for you to pay off your credit card debt is
